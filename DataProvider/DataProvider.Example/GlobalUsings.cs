...
global using StringSqlError = Outcome.Result<string, Selecta.SqlError>.Error<string, Selecta.SqlError>;
...
global using BasicOrderListOk = Outcome.Result<
    System.Collections.Generic.IReadOnlyList<DataProvider.Example.Model.BasicOrder>,
    Selecta.SqlError
>.Ok<System.Collections.Generic.IReadOnlyList<DataProvider.Example.Model.BasicOrder>, Selecta.SqlError>;
global using BasicOrderListError = Outcome.Result<
    System.Collections.Generic.IReadOnlyList<DataProvider.Example.Model.BasicOrder>,
    Selecta.SqlError
>.Error<System.Collections.Generic.IReadOnlyList<DataProvider.Example.Model.BasicOrder>, Selecta.SqlError>;
