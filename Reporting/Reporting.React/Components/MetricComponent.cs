...
namespace Reporting.React.Components
{
    ...
    public static class MetricComponent
    {
            ...
            return Div(
                ...
                children: new[]
                {
                    Div(
                        ...
                        children: new[] { Text(displayValue) }
                    ),
                    Div(
                        className: "report-metric-title",
        ...
        private static string ExtractMetricValue(object dataSourceResult, string valueField, string format)
        {
            ...
            {
                if (columns[i] == valueField) { colIndex = i; break; }
            }
