...
// /releases/ page — the browser makes ZERO network calls. Notes are rendered
// by the `releaseNotes` filter in eleventy.config.js (markdown-it, html:false),
// because release bodies carry untrusted PR titles/handles.

const REPO = "Nimblesite/DataProvider";
...
export default async function () {
  ...
  const headers = {
    "User-Agent": "DataProvider-website-build",
