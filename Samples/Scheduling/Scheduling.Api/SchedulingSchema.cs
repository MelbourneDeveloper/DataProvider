    ...
    private static SchemaDefinition BuildSchema() =>
        Schema.Define("scheduling")
            ...
            .Table("fhir_Slot", t => t
                ...
                .Column("Status", Text, c => c
                    .NotNull()
                    .Check("Status IN ('free', 'busy', 'busy-unavailable', 'busy-tentative')"))
            ...
            .Table("sync_ScheduledPatient", t => t
                .Column("PatientId", Text, c => c.PrimaryKey())
