    ...
    public static class DashboardTests
    {
        ...
        private static void NavigationTests() =>
            Describe(
                ...
                {
                    Test(
                        "renders app with sidebar and main content",
                        async () =>
                        {
                    ...
                    Test(
                        "navigates to Patients page when clicking nav item",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                    ...
                    Test(
                        "navigates to Practitioners page",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                            ...
                            Assert.ElementExists(
                                practitionersNav,
                                "Practitioners nav item should exist"
                            );
                            ...
                            Assert.TextVisible(
                                "Practitioners",
                                "Practitioners title should be visible"
                            );
                    ...
                    Test(
                        ...
                        async () =>
                        {
                            ...
                            Assert.ElementExists(
                                appointmentsNav,
                                "Appointments nav item should exist"
                            );
                            ...
                            Assert.TextVisible(
                                "Appointments",
                                "Appointments title should be visible"
                            );
                    ...
                    Test(
                        "updates header title when navigating",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
        ...
        private static void DashboardPageTests() =>
            Describe(
                "Dashboard Page",
                () =>
                {
                    Test(
                        "displays metric cards with correct data",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                            ...
                            Assert.TextVisible(
                                "Total Patients",
                                "Patient metric label should be visible"
                            );
                            ...
                            Assert.TextVisible(
                                "Practitioners",
                                "Practitioner metric label should be visible"
                            );
                    ...
                    Test(
                        ...
                        async () =>
                        {
                            ...
                            Assert.TextVisible(
                                "Quick Actions",
                                "Quick Actions title should be visible"
                            );
                            Assert.TextVisible(
                                "+ New Patient",
                                "New Patient button should be visible"
                            );
                            Assert.TextVisible(
                                "+ New Appointment",
                    ...
                    Test(
                        "displays Recent Activity section",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                            ...
                            Assert.TextVisible(
                                ...
                                "Activity item should be visible"
                            );
        ...
        private static void PatientsPageTests() =>
            Describe(
                "Patients Page",
                () =>
                {
                    Test(
                        "displays patient table with data",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                    ...
                    Test(
                        "filters patients when searching",
                        async () =>
                        {
                            var mockWithHistory = MockFetch.CreateWithHistory(
                    ...
                    Test(
                        ...
                        async () =>
                        {
                            ...
                            Assert.TextVisible(
                                "Add Patient",
                                "Add Patient button should be visible"
                            );
                    ...
                    Test(
                        "displays patient gender badges correctly",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
        ...
        private static void PractitionersPageTests() =>
            Describe(
                "Practitioners Page",
                () =>
                {
                    Test(
                        "displays practitioner cards with data",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                            ...
                            Assert.TextVisible(
                                "Sarah Williams",
                                "Practitioner name should be visible"
                            );
                            Assert.TextVisible("Cardiology", "Specialty should be visible");
                            Assert.TextVisible(
                                "James Anderson",
                                "Second practitioner should be visible"
                            );
                    ...
                    Test(
                        "shows practitioner avatars with initials",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                    ...
                    Test(
                        "displays specialty filter dropdown",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
        ...
        private static void AppointmentsPageTests() =>
            Describe(
                "Appointments Page",
                () =>
                {
                    Test(
                        "displays appointment list with data",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                            ...
                            Assert.TextVisible(
                                "Dr. Sarah Williams",
                                "Practitioner should be visible"
                            );
                    ...
                    Test(
                        "filters appointments by status when clicking tabs",
                        async () =>
                        {
                            var mock = MockFetch.Create(MockData.GetApiResponses());
                            MockFetch.Install(mock);
                            ...
                            Assert.TextVisible("booked", "Booked status badge should be visible");
        ...
        private static void SidebarTests() =>
            Describe(
                "Sidebar",
                () =>
                {
                    Test(
                        ...
                        async () =>
                        {
                            ...
                            Assert.TextVisible(
                                "Healthcare",
                                "Brand name should be visible in sidebar"
                            );
                    ...
                    Test(
                        ...
                        async () =>
                        {
                            ...
                            Assert.TextVisible(
                                "Scheduling",
                                "Scheduling section should be visible"
                            );
                    ...
                    Test(
                        ...
                        async () =>
                        {
                            ...
                            var isCollapsed = H5.Script.Write<bool>(
        ...
        private static void ErrorHandlingTests() =>
            Describe(
                "Error Handling",
                () =>
                {
                    Test(
                        "shows warning when API is unavailable",
                        async () =>
                        {
                    ...
                    Test(
                        ...
                        async () =>
                        {
                            ...
                            var delayedMock = MockFetch.CreateWithDelay(
                                MockData.GetApiResponses(),
                                2000
                            );
