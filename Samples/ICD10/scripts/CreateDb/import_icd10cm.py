...
class SQLiteImporter:
    ...
    def import_codes(self, codes: list[Code], synonyms: dict[str, list[str]]):
        ...
        # Clear existing codes (unified table supports any ICD-10 variant)
        self.conn.execute("DELETE FROM icd10_code_embedding")
        self.conn.execute("DELETE FROM icd10_code")
        ...
        for c in codes:
            ...
            self.conn.execute(
                ...
                (
                    ...
                    "2024-10-01",
                    "",
                    "2025",  # Edition as Text for country-agnostic support
                    get_timestamp(),
                    1,
                ),
            )
