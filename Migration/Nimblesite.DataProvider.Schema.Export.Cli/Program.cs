...
namespace Nimblesite.DataProvider.Schema.Export.Cli;
...
public static class Program
{
    ...
    {
        Console.WriteLine($"Nimblesite.DataProvider.Schema.Export.Cli - Export C# Schema to YAML");
    ...
    private static int ShowUsage()
    {
        ...
        Console.WriteLine(
            "  dotnet run --project Nimblesite.DataProvider.Migration.Core/Nimblesite.DataProvider.Schema.Export.Cli/Nimblesite.DataProvider.Schema.Export.Cli.csproj -- \\"
        );
        ...
        Console.WriteLine("  dotnet run -- -a bin/Debug/net9.0/Nimblesite.DataProvider.Example.dll \\");
        Console.WriteLine("               -t Nimblesite.DataProvider.Example.ExampleSchema \\");
