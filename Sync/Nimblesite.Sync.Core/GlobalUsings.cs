...
global using BatchApplyResultOk = Outcome.Result<Nimblesite.Sync.Core.BatchApplyResult, Nimblesite.Sync.Core.SyncError>.Ok<
    ...
    Nimblesite.Sync.Core.SyncError
>;
global using BatchApplyResultResult = Outcome.Result<Nimblesite.Sync.Core.BatchApplyResult, Nimblesite.Sync.Core.SyncError>;
...
global using ConflictResolutionOk = Outcome.Result<Nimblesite.Sync.Core.ConflictResolution, Nimblesite.Sync.Core.SyncError>.Ok<
    ...
    Nimblesite.Sync.Core.SyncError
>;
global using ConflictResolutionResult = Outcome.Result<Nimblesite.Sync.Core.ConflictResolution, Nimblesite.Sync.Core.SyncError>;
...
global using PullResultOk = Outcome.Result<Nimblesite.Sync.Core.PullResult, Nimblesite.Sync.Core.SyncError>.Ok<
    ...
    Nimblesite.Sync.Core.SyncError
>;
global using PullResultResult = Outcome.Result<Nimblesite.Sync.Core.PullResult, Nimblesite.Sync.Core.SyncError>;
...
global using PushResultOk = Outcome.Result<Nimblesite.Sync.Core.PushResult, Nimblesite.Sync.Core.SyncError>.Ok<
    ...
    Nimblesite.Sync.Core.SyncError
>;
global using PushResultResult = Outcome.Result<Nimblesite.Sync.Core.PushResult, Nimblesite.Sync.Core.SyncError>;
global using SyncBatchError = Outcome.Result<Nimblesite.Sync.Core.SyncBatch, Nimblesite.Sync.Core.SyncError>.Error<
...
global using SyncBatchOk = Outcome.Result<Nimblesite.Sync.Core.SyncBatch, Nimblesite.Sync.Core.SyncError>.Ok<
    ...
    Nimblesite.Sync.Core.SyncError
>;
global using SyncBatchResult = Outcome.Result<Nimblesite.Sync.Core.SyncBatch, Nimblesite.Sync.Core.SyncError>;
global using SyncLogEntryResult = Outcome.Result<Nimblesite.Sync.Core.SyncLogEntry, Nimblesite.Sync.Core.SyncError>;
...
global using SyncResultOk = Outcome.Result<Nimblesite.Sync.Core.SyncResult, Nimblesite.Sync.Core.SyncError>.Ok<
    ...
    Nimblesite.Sync.Core.SyncError
>;
global using SyncResultResult = Outcome.Result<Nimblesite.Sync.Core.SyncResult, Nimblesite.Sync.Core.SyncError>;
