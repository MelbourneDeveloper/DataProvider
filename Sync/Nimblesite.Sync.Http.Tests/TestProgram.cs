...
// Nimblesite.Sync.Http is a LIBRARY - this test project spins up the server for testing.

using Nimblesite.Sync.Http;

var options = new WebApplicationOptions { Args = args, ContentRootPath = AppContext.BaseDirectory };

var builder = WebApplication.CreateBuilder(options);

// Add sync API services using the extension method from Nimblesite.Sync.Http library
...
// Map all sync endpoints using the extension method from Nimblesite.Sync.Http library
